/**
 * Solana Crowdfunding Benchmark — Token-2022 variant (V5)
 *
 * Mirrors scripts/benchmark.ts for the cross-chain comparison in docs/measurements.md.
 * Uses spl_token_2022 (TOKEN_2022_PROGRAM_ID) for all mints and token accounts.
 *
...
async function main() {
  ...
  console.log("Solana Crowdfunding Benchmark — Token-2022 (V5)");
  ...
  process.stdout.write("Setting up Token-2022 payment mint and contributors... ");
  ...
  for (const c of contributors) {
    ...
    await mintTo(
      connection, payer, paymentMint, ata.address, payer, AMOUNT_PER_CONTRIB,
  ...
  await mintTo(
    connection, payer, paymentMint, paymentAtaAddresses[0], payer, AMOUNT_PER_CONTRIB,
    [], undefined, TOKEN_2022_PROGRAM_ID
  );
  ...
  console.log("\n" + "=".repeat(72));
  console.log("Results — Token-2022 (V5)");
  console.log("=".repeat(72));
